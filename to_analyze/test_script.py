...
ft_url = 'http://www.nfl.com/stats/categorystats?tabSeq=0&statisticCategory=TACKLES&conference=null&season=2017&seasonType=REG'
ft_directory = 'tackling'
page_filename = 'tackling.html'
csv_filename = 'tackling.csv'
